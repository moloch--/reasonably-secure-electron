...
This exploit is an excellent example of the limitations of CSPs, a CSP _cannot_ prevent XSS; it can however complicate/limit the exploitation process, or make an otherwise exploitable bug unexploitable. CSP is a seatbelt, depending upon the severity of a crash it can and very well may save you, but it's not perfect. And it's not the 80's anymore, so wear your damn seatbelt.
...
Security in general is getting better, but there's also more at stake than ever before.
